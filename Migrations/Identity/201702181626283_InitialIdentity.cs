        ...
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ProvinceCode = c.String(nullable: false, maxLength: 30),
                    })
                .PrimaryKey(t => t.CityId)
                .ForeignKey("dbo.Provinces", t => t.ProvinceCode, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                    {
                        ProvinceCode = c.String(nullable: false, maxLength: 30),
                        ProvinceName = c.String(nullable: false, maxLength: 40),
                    })
